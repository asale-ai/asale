...
const GLYPHS: Record<string, ReactNode> = {
  ...
  // OpenRouter has no brand colour of its own in its mark — it is monochrome
  // wherever they use it — so it takes the surrounding text colour and reads
  // correctly in both themes without a second asset.
  openrouter: (
...
const MARK_OF: Record<string, string> = {
  ...
  deepseek: "deepseek",
  // OpenRouter — the aggregator. Same word for both vocabularies again: it is
  // the credential family, and it is also the catalog vendor its own routing
  // models (`openrouter/auto`) are filed under.
