...
最新版 **v0.1.0**，免费。也可以直接从[官网首页](https://asale.ai)下载，会自动识别你的系统。
...
<sup>Windows / Linux 版需要在对应系统上构建（Tauri 不能跨系统打包），见
[开发文档 · 打包](docs/DEVELOPMENT.md#打包)。</sup>
...
架构说明、本地开发、打包与发布流程见 **[docs/DEVELOPMENT.md](docs/DEVELOPMENT.md)**。
